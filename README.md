> [!IMPORTANT]
> This is a fork of the [i18n-ally](https://github.com/lokalise/i18n-ally) extension, but with vue-sfc framework `namespaceAsPrefix` support and improved custom intellisense.
